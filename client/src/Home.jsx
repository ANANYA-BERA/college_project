    ...
    return(
        <div className='homepage font-serif'>
            ...
            <div className={textalign} data-aos="fade-left">
                <h2 className={headingstyle}>DR. Meghnad Saha Instite of Technology</h2>
            ...
            <div className={textalign}>
                <h2 className={headingstyle} data-aos="flip-down">DR. Meghnad Saha</h2><p className='m-1 font-bold' data-aos="fade-right">(6th Oct,1893 - 16Feb,1956)</p>
            ...
            <div className='flex gap-5'>
                ...
                <div>
                    <h2 className={headingstyle} data-aos="slide-down">Our Vision</h2>
