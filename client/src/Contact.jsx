            ...
            <div className="relative w-fit mx-7 px-35 rounded-tl-md rounded-br-md bg-gray-400">
                ...
                <div className="flex flex-col justify-center w-full pl-100">
                        <div className="align-section" data-aos="fade-left">
                            <img className="w-1/17 mr-4" src={location} alt="website-icon" />
                        ...
                        <div className="align-section" data-aos="fade-left">
                            <img className="w-15 mr-4" src={website} alt="website-icon" />
                        ...
                        <div className="align-section" data-aos="fade-left">
                            <img className="w-1/18 mr-4" src={phone} alt="website-icon" />
                        ...
                        <div className="align-section" data-aos="fade-left">
                            <img className="w-1/18 mr-4" src={email} alt="website-icon" />
