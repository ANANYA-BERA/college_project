            ...
            <div className="relative w-fit mx-7 rounded-tl-md rounded-br-md gradient">
                ...
                <div className="flex flex-col justify-center w-full pl-100">
                        <div className="align-section" data-aos="fade-left">
                            <img className="w-1/17 rounded mr-4 transition-transform duration-500 hover:scale-x-[-1]" src={location} alt="website-icon" />
                            <a className="font-bold text-blue-400 hover:text-blue-500 cursor-pointer" href={maplink} target="_blank" rel="noopener noreferrer">&nbsp;Debhog,Haldia Pin-721657,Purba Medinipur,WB,India</a>
                        </div>
                        <div className="align-section" data-aos="fade-left">
