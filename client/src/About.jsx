...
function About(){
    ...
    return(
        <div className="text-center px-8 py-5 font-serif">
            ...
            <div className={textalign} data-aos="fade-left">
                <SectionHeading color="bg-[linear-gradient(to_right,rgb(48,93,255)_40%,rgba(255,0,0,0)_80%)]" categories="About US" />
