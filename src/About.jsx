function About(){
    return(
        <div className="text-center px-10 m-5">
            <h2 className="text-violet-700 font-serif font-bold bg-gray-200 p-2 rounded-lg m-5 text-3xl shadow-md">About</h2>
